...
<div class="container mx-auto p-6">
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div class="md:col-span-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" placeholder="Masukkan nama"
                            class="mt-1 block w-full rounded-xl bg-gray-100 border border-gray-300 py-3 px-4 focus:ring-2 focus:ring-blue-500 focus:outline-hidden">
                    </div>
            ...
            <div class="card bg-white p-6 shadow-sm rounded-xl">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        class="mt-1 block w-full rounded-xl bg-gray-100 border border-gray-300 py-3 px-4 text-sm text-gray-700 focus:ring-2 focus:ring-blue-500 focus:outline-hidden appearance-none">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="textarea textarea-bordered w-full mb-4 bg-gray-100 border border-gray-300 py-3 px-4 focus:ring-2 focus:ring-blue-500 focus:outline-hidden" placeholder="Masukkan alamat detail"></textarea>
                </div>
                <div>
            ...
            <!-- Konfirmasi -->
            <div class="card bg-white p-6 shadow-sm rounded-xl space-y-4">
                <div>
            ...
            <div class="card bg-white p-6 shadow-sm rounded-xl">
                ...
                <div class="text-sm text-gray-500 space-y-2">
                    ...
                    <input id="kodePromo" type="text" placeholder="Masukkan kode promo jika ada"
                        class="bg-transparent flex-1 outline-hidden text-sm text-gray-500 placeholder:text-gray-400 px-2" />
