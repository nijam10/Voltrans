    ...
    <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <p class="mt-6 max-w-md leading-relaxed text-gray-500 sm:max-w-xs">
                Ayo mulai beralih ke kendaraan listrik, bersama Voltrans kita nikmati masa depan yang lebih hijau dan lebih baik.
            </p>
            <ul class="mt-8 flex gap-6 md:gap-8">
                <li>
                <a
                    href="#"
                    rel="noreferrer"
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:col-span-2">
                <div>
                    ...
                    <li>
                        <a class="text-gray-700 transition hover:text-green-600 hover:underline" href="#">
                        Beranda
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="text-gray-700 transition hover:text-green-600 hover:underline" href="#"> Ulasan </a>
                    </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            ...
                            <span class="flex-1 text-gray-700">contact@voltrans.com</span>
                            </a>
                        </li>
                        <li>
                            <a
                            ...
                            <span class="flex-1 text-gray-700">+62 7789012</span>
                            </a>
                        </li>
                        <li
                ...
                <div>
                    <p class="text-lg font-medium text-gray-900">Temui Kami</p>
                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                        ...
                        <li>
                            <p class="text-gray-700 transition hover:text-gray-700/75" href="#">Senin - Jumat: 08:00 - 17:00 WIB</p>
                            <p class="text-gray-700 transition hover:text-gray-700/75" href="#">Sabtu: 08:00 - 15:00 WIB</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mt-12 border-t border-gray-100 pt-6">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
                ...
                <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2025 Voltrans Rent Company</p>
            </div>
        </div>
    </div>
</footer>