    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
        <nav class="space-y-1">
            ...
            <a href="{{ route('user.orders.index') }}"
                @class([
                    'flex items-center px-4 py-2 rounded-md transition',
                    'bg-gray-100 text-gray-900 font-medium' => request()->routeIs('user.orders.*') && !request()->routeIs('user.order-items.*'),
                    'text-gray-600 hover:bg-gray-50 hover:text-gray-900' => !request()->routeIs('user.orders.*') || request()->routeIs('user.order-items.*')
                ])>
                <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <a href="{{ route('user.order-items.index') }}"
                @class([
                    'flex items-center px-4 py-2 rounded-md transition',
                    'bg-gray-100 text-gray-900 font-medium' => request()->routeIs('user.order-items.*'),
                    'text-gray-600 hover:bg-gray-50 hover:text-gray-900' => !request()->routeIs('user.order-items.*')
                ])>
                <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <div class="pb-0 px-2 w-full flex flex-col flex-wrap">
                    <ul class="space-y-1 pt-4">
                        ...
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition"
                                @class([
                                    'bg-gray-100 text-gray-800 font-medium' => request()->routeIs('user.orders.*') && !request()->routeIs('user.order-items.*'),
                                    'text-gray-600 hover:bg-gray-100 hover:text-gray-800' => !request()->routeIs('user.orders.*') || request()->routeIs('user.order-items.*')
                                ])
                        ...
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg transition"
                                @class([
                                    'bg-gray-100 text-gray-800 font-medium' => request()->routeIs('user.order-items.*'),
                                    'text-gray-600 hover:bg-gray-100 hover:text-gray-800' => !request()->routeIs('user.order-items.*')
                                ])
