        ...
        <div class="w-full md:w-1/4">
            <div class="bg-white rounded-lg shadow p-6 sticky top-4">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-2">
                        <li><input type="radio" name="radio-7" class="radio radio-success" checked="checked" /> All (107)</a></li>
                        <li><input type="radio" name="radio-7" class="radio radio-success" /> E-Bicycle (25)</a></li>
                        <li><input type="radio" name="radio-7" class="radio radio-success" /> E-Motorcycle (37)</a></li>
                        <li><input type="radio" name="radio-7" class="radio radio-success" /> E-Car (35)</a></li>
                        <li><input type="radio" name="radio-7" class="radio radio-success" /> E-Scooter (10)</a></li>
                    </ul>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @for($i = 0; $i < 9; $i++)
                    @include('components.card', [
                        'imgsrc' => 'https://placehold.co/300x200?text=Product+Image',
                        'title' => 'Wuling Air EV',
                        'categories' => 'E-Car',
                        'price' => '120.000/day',
                        'rating' => '★★★★★ 5.0'
